const CACHE='korae-blue-v4';
self.addEventListener('install',event=>{self.skipWaiting();event.waitUntil(caches.open(CACHE).then(cache=>cache.addAll(['./','./manifest.webmanifest','./koin-korae-blue-192.png','./koin-korae-blue-512.png']))) });
